      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {courses.map((course, idx) => (
            ...
            >
              <div
                className={`relative p-8 md:p-10 rounded-3xl text-white text-center overflow-hidden cursor-pointer transition-all duration-500 transform-gpu ${course.glow}`}
